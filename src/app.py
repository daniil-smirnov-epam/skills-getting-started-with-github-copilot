...
activities = {
    ...
    "Soccer Club": {
        "description": "Soccer practice focusing on teamwork, fitness, and game strategy",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["noah@mergington.edu", "mia@mergington.edu"]
    },
    "School Band": {
        "description": "Play instruments together and prepare for school performances",
        "schedule": "Tuesdays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["charlotte@mergington.edu", "henry@mergington.edu"]
    },
    "Drama Club": {
        "description": "Acting workshops, improv exercises, and stage productions",
